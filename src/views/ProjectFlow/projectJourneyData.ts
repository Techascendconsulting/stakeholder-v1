...
export const projectJourneyStages: ProjectJourneyStage[] = [
  ...
  {
    id: 'stage-4-stakeholder-meeting',
    title: 'Stakeholder Conversations',
    description: 'Conduct AI-powered stakeholder interviews to gather requirements, understand pain points, and validate assumptions.',
    icon: '💬',
