-- ======================================
-- FINAL MVP BUILDER SETUP (No Projects Table)
-- Complete database setup without foreign key dependencies
-- ======================================

-- 1. Create tables if they don't exist
CREATE TABLE IF NOT EXISTS public.epics (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  project_id UUID, -- No foreign key constraint
  title TEXT NOT NULL,
  description TEXT,
