-- ====================================================================
-- COMPLETE DATABASE RESTORATION - Fix All Missing Functions & Tables
-- Run this in your Supabase SQL Editor to restore ALL missing components
-- ====================================================================
...
-- 7. Create the log_user_activity function
...
-- 8. Create the get_user_details_with_emails function
CREATE OR REPLACE FUNCTION public.get_user_details_with_emails(user_uuid UUID)
RETURNS TABLE (
  id UUID,
  email TEXT,
  display_name TEXT,
...
BEGIN
  ...
  RAISE NOTICE '- user_onboarding table created';
  RAISE NOTICE '- log_user_activity function created';
  RAISE NOTICE '- get_user_details_with_emails function created';
