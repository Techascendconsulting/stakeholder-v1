...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
          ...
          <div className="max-w-4xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
              ...
              <div className="bg-gradient-to-br from-black/60 to-gray-900/60 backdrop-blur-md rounded-2xl px-6 py-4 border border-purple-500/40 shadow-xl hover:border-purple-400 transition-all">
                ...
                <div className="text-xs md:text-sm text-gray-300">Powered Practice</div>
              </div>
              <div className="bg-gradient-to-br from-black/60 to-gray-900/60 backdrop-blur-md rounded-2xl px-6 py-4 border border-purple-500/40 shadow-xl hover:border-purple-400 transition-all">
                <div className="text-2xl md:text-3xl font-bold text-white mb-1">24/7</div>
                <div className="text-xs md:text-sm text-gray-300">AI Support</div>
              </div>
            </div>

            <div className="inline-flex items-center bg-gradient-to-r from-purple-600/90 to-indigo-700/90 backdrop-blur-md border border-purple-400/50 text-white px-6 py-2 rounded-full text-sm font-medium mb-8 shadow-xl">
              <Users className="w-4 h-4 mr-2" />
              Join 3,247+ Successful Business Analysts
            </div>
      ...
      <section className="py-24 bg-gradient-to-br from-purple-200 via-purple-100 to-indigo-100 border-t border-purple-200" id="why">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              Why BA WorkXP?
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-white rounded-2xl shadow-xl p-8 border border-cyan-100 hover:shadow-2xl transition-all">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">AI-Powered Practice</h3>
              <p className="text-gray-600 mb-6 leading-relaxed">
                Practice elicitation, documentation, MVP building, and Scrum with realistic AI stakeholders. Get instant feedback and improve your skills with every session.
              </p>
              <button
