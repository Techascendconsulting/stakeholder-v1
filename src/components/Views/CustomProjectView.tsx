    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Creating Your Custom Project</h2>
          <p className="text-gray-600 mb-6">AI is analyzing your project context and generating stakeholders...</p>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h1 className="text-3xl font-bold text-gray-900">Create Custom Project</h1>
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Tell us about your project context and objectives</p>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Customer Onboarding Process Improvement"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  />
                </div>

                <div>
                  <label className="block text-sm font-semibold text-gray-900 mb-2">Business Context *</label>
                  <textarea
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Process & Outcomes</h2>
                <p className="text-gray-600">Describe current state and desired future state</p>
              </div>

              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-900 mb-2">Current Process (As-Is) *</label>
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent h-40 resize-none"
                  />
                </div>

                <div>
                  <label className="block text-sm font-semibold text-gray-900 mb-2">Desired Outcomes (To-Be) *</label>
                  <textarea
                    ...
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent h-40 resize-none"
                  />
                  <p className="text-xs text-gray-500 mt-1">Enter each goal on a separate line</p>
                </div>

                <div>
                  <label className="block text-sm font-semibold text-gray-900 mb-2">Project Complexity</label>
                  <select
          ...
          {currentStep === 3 && (
            <div className="space-y-6">
              <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Stakeholders & Context</h2>
                <p className="text-gray-600">Define who will be involved and project context</p>
              </div>

              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-900 mb-2">Key Stakeholder Roles *</label>
