...
interface ProjectsViewProps {
  embedded?: boolean; // When true, hide header and back button
}

const ProjectsView: React.FC<ProjectsViewProps> = ({ embedded = false }) => {
  ...
  return (
    <div className={embedded ? "" : "min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-indigo-900/20"}>
      
      <div className={embedded ? "p-6" : "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"}>
        
        {/* Enhanced Header Section with Back Button - Only show when not embedded */}
        {!embedded && (
          <div className="mb-12">
            {/* Back Button */}
            <div className="mb-8">
