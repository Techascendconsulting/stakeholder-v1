-- ======================================
-- MVP BUILDER WITH EXISTING STRUCTURE
-- Works with existing tables, adds missing columns only
-- ======================================
...
-- 2. Create MVP flows table if it doesn't exist
...
-- 4. Create/Update RLS Policies (drop existing first)
...
SELECT 'Tables with RLS enabled:' as info, COUNT(*) as count FROM information_schema.tables WHERE table_schema = 'public' AND table_name IN ('epics', 'stories', 'acceptance_criteria', 'mvp_flows');
