      ...
      <div className="relative bg-white dark:bg-gray-800 border-b border-slate-200 dark:border-gray-700">
        ...
        <div className="absolute top-6 left-6 z-10">
          <button
            ...
            className="inline-flex items-center space-x-2 bg-white text-slate-700 dark:text-slate-200 px-4 py-2 rounded-lg font-semibold transition-all duration-200 hover:bg-slate-50 dark:hover:bg-gray-700 border border-slate-200 dark:border-gray-700 shadow-sm"
          >
