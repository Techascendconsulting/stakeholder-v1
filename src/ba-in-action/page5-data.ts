...
export const PAGE_5_DATA: Record<BAInActionProject, Page5Data> = {
  cif: {
    ...
    exampleNarrative: {
      ...
      toBe: '"Risk-tiering that adapts, embedded feedback loops, Ops interface that guides decisions, conversion guardrails built into scoring."',
    },
  ...
  voids: {
    ...
    exampleNarrative: {
      ...
      toBe: '"Streamlined handover that adapts, embedded feedback loops, Repairs interface that guides work orders, rent recovery guardrails built into process."',
    },
    taskPlaceholder: 'Capture your As-Is narrative, gap explanation, why it matters, and the direction of the To-Be...',
  },
};
