interface ElevenLabsStakeholder {
  ...
  voice?: string; // Murf TTS voice (for compatibility)
...
export const ELEVENLABS_PROJECTS: ElevenLabsProject[] = [
  {
    ...
    context: {
              currentState: 'Manual onboarding process taking 2 to 3 weeks, high customer confusion, 25% drop-off rate during first month',
      currentProcessFlow: {
